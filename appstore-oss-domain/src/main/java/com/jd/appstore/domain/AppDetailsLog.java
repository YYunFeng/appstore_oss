 ...
 * 应用详情信息日志表
 */
public class AppDetailsLog implements Serializable {
    /**
     * 详情ID
     */
    private Integer id;
    ...
    public int getPriceSyncFlag() {
        return priceSyncFlag;
    }

    public void setPriceSyncFlag(int priceSyncFlag) {
    ...
    public Integer getAppVersioCode() {
        return appVersioCode;
    }

    public void setAppVersioCode(Integer appVersioCode) {
        this.appVersioCode = appVersioCode;
    }
