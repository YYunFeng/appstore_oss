...
function HS_calender(){
	...
	style +=".calender { width:170px; height:auto; font-size:12px;margin:28px 0 0 -145px; background:url(calenderbg.gif) no-repeat right center #fff; border:1px solid #397EAE; padding:1px}";
